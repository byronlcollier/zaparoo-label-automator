...
class PlatformScraper(IgdbScraper):
    ...
    def _scrape_platform_info(self, platform_ids: list[int]) -> list:
        id_filter = ','.join(str(pid) for pid in platform_ids)
    ...
    def scrape(self) -> list:
        ...
        if len(platform_data) != len(self._requested_platforms):
